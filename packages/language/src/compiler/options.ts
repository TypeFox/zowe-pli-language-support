...
export declare namespace CompilerOptions {
    ...
    export type ListView = 'SOURCE' | 'AFTERALL' | 'AFTERCICS' | 'AFTERMACRO' | 'AFTERSQL';
    ...
    export type Semantic = true | {
        flag?: CompilerOptions.Flag;
    };
    export type Syntax = true | {
        flag?: CompilerOptions.Flag;
    };
    export type System = 'MVS' | 'CICS' | 'IMS' | 'OS' | 'TSO';
    export type Test = false | {
